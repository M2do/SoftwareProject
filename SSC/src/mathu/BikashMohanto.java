 ...
 * @author Papun Gandha
 */
public class BikashMohanto extends javax.swing.JFrame {

    /**
     * Creates new form BikashMohanto
     */
    public BikashMohanto() {
        initComponents();
        try
        {
            Scanner mathuratudu = new Scanner(new File("Bikash.txt"));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bikash Mohanto");
    ...
    private void MaddFriendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MaddFriendActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"You added Bikash Mohanto","Adding Friend",JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BikashMohanto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
