 ...
 * @author Papun Gandha
 */
public class RamdasMajhi extends javax.swing.JFrame {

    /**
     * Creates new form RamdasMajhi
     */
    public RamdasMajhi() {
        initComponents();
        try
        {
            Scanner mathuratudu = new Scanner(new File("Ramdas.txt"));
    ...
    private void MaddFriendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MaddFriendActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"You added Ramdas Majhi","Adding Friend",JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RamdasMajhi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
