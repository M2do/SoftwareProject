 ...
 * @author Papun Gandha
 */
public class DhirajTandi extends javax.swing.JFrame {

    /**
     * Creates new form DhirajTandi
     */
    public DhirajTandi() {
        initComponents();
         try
        {
            Scanner mathuratudu = new Scanner(new File("Dhiraj.txt"));
    ...
    private void MaddFriendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MaddFriendActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"You added Dhiraj Kumar","Adding Friend",JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DhirajTandi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
