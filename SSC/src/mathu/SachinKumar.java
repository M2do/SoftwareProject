 ...
 * @author Papun Gandha
 */
public class SachinKumar extends javax.swing.JFrame {

    /**
     * Creates new form SachinKumar
     */
    public SachinKumar() {
        initComponents();
        try
        {
            Scanner mathuratudu = new Scanner(new File("Sachin.txt"));
    ...
    private void MaddFriendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MaddFriendActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"You added Sachin Kumar","Adding Friend",JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SachinKumar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
