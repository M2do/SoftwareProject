 ...
 * @author Papun Gandha
 */
public class RishabhPrakash extends javax.swing.JFrame {

    /**
     * Creates new form RishabhPrakash
     */
    public RishabhPrakash() {
        initComponents();
         try
        {
            Scanner mathuratudu = new Scanner(new File("Rishabh.txt"));
    ...
    private void MaddFriendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MaddFriendActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"You added Rishabh Prakash","Adding Friend",JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RishabhPrakash.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
