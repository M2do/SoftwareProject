 ...
 * @author Papun Gandha
 */
public class BiswajeetBehera extends javax.swing.JFrame {

    /**
     * Creates new form BiswajeetBehera
     */
    public BiswajeetBehera() {
        initComponents();
        try
        {
            Scanner mathuratudu = new Scanner(new File("Biswajeet.txt"));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Biswajeet Behera");
    ...
    private void MaddFriendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MaddFriendActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"You added Biswajeet Behera","Adding Friend",JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BiswajeetBehera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
