 ...
 * @author Papun Gandha
 */
public class KuldeepSingh extends javax.swing.JFrame {

    /**
     * Creates new form KuldeepSingh
     */
    public KuldeepSingh() {
        initComponents();
        try
        {
            Scanner mathuratudu = new Scanner(new File("Kuldeep.txt"));
    ...
    private void MaddFriendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MaddFriendActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"You added Kuldeep Singh","Adding Friend",JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KuldeepSingh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
