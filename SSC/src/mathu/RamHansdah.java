 ...
 * @author Papun Gandha
 */
public class RamHansdah extends javax.swing.JFrame {

    /**
     * Creates new form RamHansdah
     */
    public RamHansdah() {
        initComponents();
        try
        {
            Scanner mathuratudu = new Scanner(new File("Ram.txt"));
    ...
    private void MaddFriendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MaddFriendActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"You added Ram Hansdah","Adding Friend",JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RamHansdah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
